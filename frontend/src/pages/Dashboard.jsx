...
export default function Dashboard() {
  ...
  return (
    <div>
      ...
      {/* Pannello M2 tecnico + stato modalità/provider: riservato ad ADMIN
          (item #9 — il percorso cliente non deve mai vedere terminologia
          tecnica M2/SIMULATO, ne' un CTA verso "Piani M2", ormai sostituito
          da Sala Riunioni per l'approvazione e l'avvio del lavoro). */}
      {isAdmin && (
