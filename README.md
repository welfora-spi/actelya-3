...
- Appointment Setter: proposta/prenotazione reale di appuntamenti (Google Calendar/Microsoft Graph/Calendly), sempre da lead approvati, mai una conferma inventata, prevenzione doppie prenotazioni, cancellazione/riprogrammazione.
- Professional Tool Registry: catalogo canonico backend di 63 strumenti professionali in 22 categorie (LLM, ricerca web, media, social, advertising, CRM, prospect research, comunicazioni, email marketing, calendari, analytics, SMS, e-commerce, documenti, OCR, automazioni), con stato onesto per organizzazione — 12 già reali, il resto esplicitamente predisposto.
